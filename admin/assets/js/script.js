$(document).ready(function () {
    ...
    if ($('.datanew').length > 0) { $('.datanew').DataTable({ "bFilter": false, "sDom": 'Btlpi', 'pagingType': 'numbers', "ordering": false, "language": { search: ' ', sLengthMenu: '_MENU_', searchPlaceholder: "Search...", info: "_START_ - _END_ of _TOTAL_ items", }, initComplete: (settings, json) => { $('.dataTables_filter').appendTo('#tableSearch'); $('.dataTables_filter').appendTo('.search-input'); }, }); }
